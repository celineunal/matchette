...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //This is what I tried to fix the buggy animation but it doesn't work.
    ...
    //This is from when I tried to implement custom animation, but it's buggier as is.
/*    *//**
    ...
    public void show_layout(LinearLayout l) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(l, "y", screenHeight, (screenHeight * 0.6F));
